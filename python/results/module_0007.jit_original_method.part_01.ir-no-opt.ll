...
concatenate.pivot.24.:                            ; preds = %bitcast_concatenate_fusion.1.clone.loop_body.dim.1
  %22 = icmp ult i64 %bitcast_concatenate_fusion.1.clone.indvar.dim.1, 24
...
concatenate.pivot.44.:                            ; preds = %concatenate.pivot.24.
  %23 = icmp ult i64 %bitcast_concatenate_fusion.1.clone.indvar.dim.1, 44
