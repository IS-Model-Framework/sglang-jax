...
slice.4.clone.loop_header.dim.2.preheader.us:     ; preds = %slice.4.clone.loop_header.dim.1.preheader.us, %slice.4.clone.loop_header.dim.2.preheader.us
  ...
  %2 = getelementptr inbounds [3 x [10000 x [64 x float]]], ptr %arg0, i64 0, i64 %slice.4.clone.invar_address.dim.0.010.us, i64 %slice.4.clone.invar_address.dim.1.08.us, i64 44
  %3 = getelementptr inbounds [3 x [10000 x [20 x float]]], ptr %arg1, i64 0, i64 %slice.4.clone.invar_address.dim.0.010.us, i64 %slice.4.clone.invar_address.dim.1.08.us, i64 0
  %4 = load <8 x float>, ptr %2, align 16, !invariant.load !1, !noalias !5
  store <8 x float> %4, ptr %3, align 16, !alias.scope !5
  %5 = getelementptr inbounds [3 x [10000 x [64 x float]]], ptr %arg0, i64 0, i64 %slice.4.clone.invar_address.dim.0.010.us, i64 %slice.4.clone.invar_address.dim.1.08.us, i64 52
  %6 = getelementptr inbounds [3 x [10000 x [20 x float]]], ptr %arg1, i64 0, i64 %slice.4.clone.invar_address.dim.0.010.us, i64 %slice.4.clone.invar_address.dim.1.08.us, i64 8
  %7 = load <8 x float>, ptr %5, align 16, !invariant.load !1, !noalias !5
  store <8 x float> %7, ptr %6, align 16, !alias.scope !5
  %8 = getelementptr inbounds [3 x [10000 x [64 x float]]], ptr %arg0, i64 0, i64 %slice.4.clone.invar_address.dim.0.010.us, i64 %slice.4.clone.invar_address.dim.1.08.us, i64 60
  %9 = getelementptr inbounds [3 x [10000 x [20 x float]]], ptr %arg1, i64 0, i64 %slice.4.clone.invar_address.dim.0.010.us, i64 %slice.4.clone.invar_address.dim.1.08.us, i64 16
  %10 = load <4 x float>, ptr %8, align 16, !invariant.load !1, !noalias !5
