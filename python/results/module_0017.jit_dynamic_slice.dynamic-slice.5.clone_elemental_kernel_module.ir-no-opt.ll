...
dynamic-slice.5.clone.loop_header.dim.2:          ; preds = %dynamic-slice.5.clone.loop_body.dim.2, %dynamic-slice.5.clone.loop_body.dim.1
  ...
  %4 = icmp uge i64 %dynamic-slice.5.clone.indvar.dim.2, 20
...
dynamic-slice.5.clone.loop_body.dim.2:            ; preds = %dynamic-slice.5.clone.loop_header.dim.2
  ...
  %23 = getelementptr inbounds [3 x [10000 x [20 x float]]], ptr %arg0, i64 0, i64 %20, i64 %21, i64 %22
  %24 = load float, ptr %23, align 4, !invariant.load !1, !noalias !6
  %25 = getelementptr inbounds [1 x [10000 x [20 x float]]], ptr %arg4, i64 0, i64 0, i64 %dynamic-slice.5.clone.indvar.dim.1, i64 %dynamic-slice.5.clone.indvar.dim.2
