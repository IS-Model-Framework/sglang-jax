...
concat_index_from_operand_id0:                    ; preds = %concatenate.pivot.0.
  ...
  %6 = getelementptr inbounds [10000 x [24 x float]], ptr %arg0, i64 0, i64 %concatenate.4.clone.indvar.dim.0, i64 %5
  %7 = load float, ptr %6, align 4, !invariant.load !1, !noalias !6
  br label %concatenate.4.clone.merge

concat_index_from_operand_id1:                    ; preds = %concatenate.pivot.24.8
  %8 = phi i64 [ 24, %concatenate.pivot.24.8 ]
  %9 = sub nsw i64 %concatenate.4.clone.indvar.dim.1, %8
  %10 = getelementptr inbounds [10000 x [20 x float]], ptr %arg1, i64 0, i64 %concatenate.4.clone.indvar.dim.0, i64 %9
  %11 = load float, ptr %10, align 4, !invariant.load !1, !noalias !6
  br label %concatenate.4.clone.merge

concat_index_from_operand_id2:                    ; preds = %concatenate.pivot.44.9
  %12 = phi i64 [ 44, %concatenate.pivot.44.9 ]
  %13 = sub nsw i64 %concatenate.4.clone.indvar.dim.1, %12
  %14 = getelementptr inbounds [10000 x [20 x float]], ptr %arg2, i64 0, i64 %concatenate.4.clone.indvar.dim.0, i64 %13
  %15 = load float, ptr %14, align 4, !invariant.load !1, !noalias !6
  br label %concatenate.4.clone.merge

concatenate.pivot.24.:                            ; preds = %concatenate.4.clone.loop_body.dim.1
  %16 = icmp ult i64 %concatenate.4.clone.indvar.dim.1, 24
  br i1 %16, label %concatenate.pivot.0., label %concatenate.pivot.44.
...
concatenate.pivot.44.:                            ; preds = %concatenate.pivot.24.
  %17 = icmp ult i64 %concatenate.4.clone.indvar.dim.1, 44
  br i1 %17, label %concatenate.pivot.24.8, label %concatenate.pivot.44.9

concatenate.pivot.24.8:                           ; preds = %concatenate.pivot.44.
  br label %concat_index_from_operand_id1

concatenate.pivot.44.9:                           ; preds = %concatenate.pivot.44.
