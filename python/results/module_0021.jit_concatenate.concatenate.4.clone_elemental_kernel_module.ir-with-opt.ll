...
vector.ph:                                        ; preds = %1, %vector.ph
  ...
  %2 = getelementptr inbounds [10000 x [24 x float]], ptr %arg0, i64 0, i64 %concatenate.4.clone.invar_address.dim.0.012, <8 x i64> <i64 0, i64 1, i64 2, i64 3, i64 4, i64 5, i64 6, i64 7>
  ...
  %4 = getelementptr inbounds [10000 x [24 x float]], ptr %arg0, i64 0, i64 %concatenate.4.clone.invar_address.dim.0.012, <8 x i64> <i64 8, i64 9, i64 10, i64 11, i64 12, i64 13, i64 14, i64 15>
  ...
  %6 = getelementptr inbounds [10000 x [24 x float]], ptr %arg0, i64 0, i64 %concatenate.4.clone.invar_address.dim.0.012, <8 x i64> <i64 16, i64 17, i64 18, i64 19, i64 20, i64 21, i64 22, i64 23>
  ...
  %8 = getelementptr inbounds [10000 x [20 x float]], ptr %arg1, i64 0, i64 %concatenate.4.clone.invar_address.dim.0.012, <8 x i64> <i64 0, i64 1, i64 2, i64 3, i64 4, i64 5, i64 6, i64 7>
  ...
  %10 = getelementptr inbounds [10000 x [20 x float]], ptr %arg1, i64 0, i64 %concatenate.4.clone.invar_address.dim.0.012, <8 x i64> <i64 8, i64 9, i64 10, i64 11, i64 12, i64 13, i64 14, i64 15>
  ...
  %12 = getelementptr inbounds [10000 x [20 x float]], ptr %arg2, i64 0, i64 %concatenate.4.clone.invar_address.dim.0.012, <8 x i64> <i64 poison, i64 poison, i64 poison, i64 poison, i64 0, i64 1, i64 2, i64 3>
  %13 = getelementptr inbounds [10000 x [20 x float]], ptr %arg1, i64 0, i64 %concatenate.4.clone.invar_address.dim.0.012, <8 x i64> <i64 16, i64 17, i64 18, i64 19, i64 poison, i64 poison, i64 poison, i64 poison>
  %predphi14.5 = shufflevector <8 x ptr> %13, <8 x ptr> %12, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 12, i32 13, i32 14, i32 15>
  %wide.masked.gather.5 = tail call <8 x float> @llvm.masked.gather.v8f32.v8p0(<8 x ptr> %predphi14.5, i32 4, <8 x i1> splat (i1 true), <8 x float> poison), !invariant.load !1, !noalias !6
  %14 = getelementptr inbounds [10000 x [64 x float]], ptr %arg3, i64 0, i64 %concatenate.4.clone.invar_address.dim.0.012, i64 40
  store <8 x float> %wide.masked.gather.5, ptr %14, align 32, !alias.scope !6
  %15 = getelementptr inbounds [10000 x [20 x float]], ptr %arg2, i64 0, i64 %concatenate.4.clone.invar_address.dim.0.012, <8 x i64> <i64 4, i64 5, i64 6, i64 7, i64 8, i64 9, i64 10, i64 11>
  %wide.masked.gather.6 = tail call <8 x float> @llvm.masked.gather.v8f32.v8p0(<8 x ptr> %15, i32 4, <8 x i1> splat (i1 true), <8 x float> poison), !invariant.load !1, !noalias !6
  %16 = getelementptr inbounds [10000 x [64 x float]], ptr %arg3, i64 0, i64 %concatenate.4.clone.invar_address.dim.0.012, i64 48
  store <8 x float> %wide.masked.gather.6, ptr %16, align 64, !alias.scope !6
  %17 = getelementptr inbounds [10000 x [20 x float]], ptr %arg2, i64 0, i64 %concatenate.4.clone.invar_address.dim.0.012, <8 x i64> <i64 12, i64 13, i64 14, i64 15, i64 16, i64 17, i64 18, i64 19>
  %wide.masked.gather.7 = tail call <8 x float> @llvm.masked.gather.v8f32.v8p0(<8 x ptr> %17, i32 4, <8 x i1> splat (i1 true), <8 x float> poison), !invariant.load !1, !noalias !6
  %18 = getelementptr inbounds [10000 x [64 x float]], ptr %arg3, i64 0, i64 %concatenate.4.clone.invar_address.dim.0.012, i64 56
  store <8 x float> %wide.masked.gather.7, ptr %18, align 32, !alias.scope !6
