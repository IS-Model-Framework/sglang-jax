...
@dynamic-slice.5.clone_parallel_bounds = private constant [5 x [2 x [2 x i64]]] [[2 x [2 x i64]] [[2 x i64] [i64 0, i64 1], [2 x i64] [i64 0, i64 2000]], [2 x [2 x i64]] [[2 x i64] [i64 0, i64 1], [2 x i64] [i64 2000, i64 4000]], [2 x [2 x i64]] [[2 x i64] [i64 0, i64 1], [2 x i64] [i64 4000, i64 6000]], [2 x [2 x i64]] [[2 x i64] [i64 0, i64 1], [2 x i64] [i64 6000, i64 8000]], [2 x [2 x i64]] [[2 x i64] [i64 0, i64 1], [2 x i64] [i64 8000, i64 10000]]]
...
define ptr @dynamic-slice.5.clone_kernel(ptr %0) #0 {
  ...
  %lo_dim_0_gep = getelementptr inbounds [5 x [2 x [2 x i64]]], ptr @dynamic-slice.5.clone_parallel_bounds, i32 0, i64 %tid_x, i32 0, i32 0
  %up_dim_0_gep = getelementptr inbounds [5 x [2 x [2 x i64]]], ptr @dynamic-slice.5.clone_parallel_bounds, i32 0, i64 %tid_x, i32 0, i32 1
  %lo_dim_0 = load i64, ptr %lo_dim_0_gep, align 4
  %up_dim_0 = load i64, ptr %up_dim_0_gep, align 4
  %lo_dim_1_gep = getelementptr inbounds [5 x [2 x [2 x i64]]], ptr @dynamic-slice.5.clone_parallel_bounds, i32 0, i64 %tid_x, i32 1, i32 0
  %up_dim_1_gep = getelementptr inbounds [5 x [2 x [2 x i64]]], ptr @dynamic-slice.5.clone_parallel_bounds, i32 0, i64 %tid_x, i32 1, i32 1
...
dynamic-slice.5.clone.loop_header.dim.2:          ; preds = %dynamic-slice.5.clone.loop_body.dim.2, %dynamic-slice.5.clone.loop_body.dim.1
  ...
  %4 = icmp uge i64 %dynamic-slice.5.clone.indvar.dim.2, 24
...
dynamic-slice.5.clone.loop_body.dim.2:            ; preds = %dynamic-slice.5.clone.loop_header.dim.2
  ...
  %10 = load i32, ptr %arg2, align 4, !invariant.load !1, !noalias !6
  ...
  %19 = icmp sle i64 40, %18
  %dynamic-slice.5.clone.start_idx2 = select i1 %19, i64 40, i64 %18
  ...
  %23 = getelementptr inbounds [3 x [10000 x [64 x float]]], ptr %arg0, i64 0, i64 %20, i64 %21, i64 %22
  %24 = load float, ptr %23, align 4, !invariant.load !1, !noalias !6
  %25 = getelementptr inbounds [1 x [10000 x [24 x float]]], ptr %arg4, i64 0, i64 0, i64 %dynamic-slice.5.clone.indvar.dim.1, i64 %dynamic-slice.5.clone.indvar.dim.2
