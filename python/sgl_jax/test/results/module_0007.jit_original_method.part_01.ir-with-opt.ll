...
vector.ph:                                        ; preds = %1, %vector.ph
  ...
  %6 = getelementptr inbounds [3 x [10000 x [64 x float]]], ptr %arg0, i64 0, <8 x i64> splat (i64 1), i64 %bitcast_concatenate_fusion.1.clone.invar_address.dim.0.03, <8 x i64> <i64 16, i64 17, i64 18, i64 19, i64 20, i64 21, i64 22, i64 23>
  ...
  %12 = getelementptr inbounds [3 x [10000 x [64 x float]]], ptr %arg0, i64 0, <8 x i64> splat (i64 2), i64 %bitcast_concatenate_fusion.1.clone.invar_address.dim.0.03, <8 x i64> <i64 40, i64 41, i64 42, i64 43, i64 44, i64 45, i64 46, i64 47>
