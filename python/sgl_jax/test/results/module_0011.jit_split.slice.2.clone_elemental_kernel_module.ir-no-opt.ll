...
slice.2.clone.loop_header.dim.2:                  ; preds = %slice.2.clone.loop_body.dim.2, %slice.2.clone.loop_body.dim.1
  ...
  %4 = icmp uge i64 %slice.2.clone.indvar.dim.2, 16
...
slice.2.clone.loop_body.dim.2:                    ; preds = %slice.2.clone.loop_header.dim.2
  ...
  %10 = getelementptr inbounds [3 x [10000 x [16 x float]]], ptr %arg1, i64 0, i64 %slice.2.clone.indvar.dim.0, i64 %slice.2.clone.indvar.dim.1, i64 %slice.2.clone.indvar.dim.2
