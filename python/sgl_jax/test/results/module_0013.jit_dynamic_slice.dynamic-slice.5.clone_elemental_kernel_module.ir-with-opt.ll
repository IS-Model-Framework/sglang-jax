...
dynamic-slice.5.clone.loop_header.dim.2.preheader.us: ; preds = %dynamic-slice.5.clone.loop_header.dim.1.preheader.us, %dynamic-slice.5.clone.loop_header.dim.2.preheader.us
  ...
  %4 = getelementptr inbounds [3 x [10000 x [16 x float]]], ptr %arg0, i64 0, i64 %dynamic-slice.5.clone.start_idx0, i64 %dynamic-slice.5.clone.invar_address.dim.1.015.us, i64 0
  %5 = getelementptr inbounds [1 x [10000 x [16 x float]]], ptr %arg4, i64 0, i64 0, i64 %dynamic-slice.5.clone.invar_address.dim.1.015.us, i64 0
  %6 = load <8 x float>, ptr %4, align 64, !invariant.load !1, !noalias !6
  store <8 x float> %6, ptr %5, align 64, !alias.scope !6
  %7 = getelementptr inbounds [3 x [10000 x [16 x float]]], ptr %arg0, i64 0, i64 %dynamic-slice.5.clone.start_idx0, i64 %dynamic-slice.5.clone.invar_address.dim.1.015.us, i64 8
  %8 = getelementptr inbounds [1 x [10000 x [16 x float]]], ptr %arg4, i64 0, i64 0, i64 %dynamic-slice.5.clone.invar_address.dim.1.015.us, i64 8
