...
define noalias noundef ptr @dynamic-slice.5.clone_kernel(ptr readonly captures(none) %0) local_unnamed_addr #0 {
  ...
  %3 = tail call i32 @llvm.umin.i32(i32 %narrow13, i32 40)
...
dynamic-slice.5.clone.loop_header.dim.1.preheader.us: ; preds = %1
  ...
  %7 = add nuw nsw i64 %dynamic-slice.5.clone.start_idx2, 16
...
dynamic-slice.5.clone.loop_header.dim.2.preheader.us: ; preds = %dynamic-slice.5.clone.loop_header.dim.1.preheader.us, %dynamic-slice.5.clone.loop_header.dim.2.preheader.us
  ...
  %8 = getelementptr inbounds [3 x [10000 x [64 x float]]], ptr %arg0, i64 0, i64 %dynamic-slice.5.clone.start_idx0, i64 %dynamic-slice.5.clone.invar_address.dim.1.017.us, i64 %dynamic-slice.5.clone.start_idx2
  %9 = getelementptr inbounds [1 x [10000 x [24 x float]]], ptr %arg4, i64 0, i64 0, i64 %dynamic-slice.5.clone.invar_address.dim.1.017.us, i64 0
  %10 = load <8 x float>, ptr %8, align 4, !invariant.load !1, !noalias !6
  store <8 x float> %10, ptr %9, align 32, !alias.scope !6
  %11 = getelementptr inbounds [3 x [10000 x [64 x float]]], ptr %arg0, i64 0, i64 %dynamic-slice.5.clone.start_idx0, i64 %dynamic-slice.5.clone.invar_address.dim.1.017.us, i64 %6
  %12 = getelementptr inbounds [1 x [10000 x [24 x float]]], ptr %arg4, i64 0, i64 0, i64 %dynamic-slice.5.clone.invar_address.dim.1.017.us, i64 8
  %13 = load <8 x float>, ptr %11, align 4, !invariant.load !1, !noalias !6
  store <8 x float> %13, ptr %12, align 32, !alias.scope !6
  %14 = getelementptr inbounds [3 x [10000 x [64 x float]]], ptr %arg0, i64 0, i64 %dynamic-slice.5.clone.start_idx0, i64 %dynamic-slice.5.clone.invar_address.dim.1.017.us, i64 %7
  %15 = getelementptr inbounds [1 x [10000 x [24 x float]]], ptr %arg4, i64 0, i64 0, i64 %dynamic-slice.5.clone.invar_address.dim.1.017.us, i64 16
  %16 = load <8 x float>, ptr %14, align 4, !invariant.load !1, !noalias !6
  store <8 x float> %16, ptr %15, align 32, !alias.scope !6
